...
public partial class GameContext {
    ...
    public GameEntity characterInfoPanelEntity { get { return GetGroup(GameMatcher.CharacterInfoPanel).GetSingleEntity(); } }
    public Entitas.Data.CharacterInfoPanel characterInfoPanel { get { return characterInfoPanelEntity.characterInfoPanel; } }
    public bool hasCharacterInfoPanel { get { return characterInfoPanelEntity != null; } }

    public GameEntity SetCharacterInfoPanel(Entitas.Data.IScrollView newCharacterScrollView) {
        if (hasCharacterInfoPanel) {
            throw new Entitas.EntitasException("Could not set CharacterInfoPanel!\n" + this + " already has an entity with Entitas.Data.CharacterInfoPanel!",
                "You should check if the context already has a characterInfoPanelEntity before setting it or use context.ReplaceCharacterInfoPanel().");
        }
        var entity = CreateEntity();
        entity.AddCharacterInfoPanel(newCharacterScrollView);
        return entity;
    }

    public void ReplaceCharacterInfoPanel(Entitas.Data.IScrollView newCharacterScrollView) {
        var entity = characterInfoPanelEntity;
        if (entity == null) {
            entity = SetCharacterInfoPanel(newCharacterScrollView);
        } else {
            entity.ReplaceCharacterInfoPanel(newCharacterScrollView);
        }
    }

    public void RemoveCharacterInfoPanel() {
        characterInfoPanelEntity.Destroy();
    }
}
...
public partial class GameEntity {
    ...
    static readonly Entitas.Data.CharacterComponent characterComponent = new Entitas.Data.CharacterComponent();
...
public partial class GameEntity {
    ...
    public Entitas.Data.NameComponent name { get { return (Entitas.Data.NameComponent)GetComponent(GameComponentsLookup.Name); } }
    ...
    public void AddName(string newValue) {
        ...
        var component = CreateComponent<Entitas.Data.NameComponent>(index);
        component.Value = newValue;
        AddComponent(index, component);
    }
...
public partial class GameEntity {
    ...
    public Entitas.Data.WorkComponent work { get { return (Entitas.Data.WorkComponent)GetComponent(GameComponentsLookup.Work); } }
    public bool hasWork { get { return HasComponent(GameComponentsLookup.Work); } }

    public void AddWork(System.Collections.Generic.List<int> newValue) {
        var index = GameComponentsLookup.Work;
        var component = CreateComponent<Entitas.Data.WorkComponent>(index);
        component.Value = newValue;
        AddComponent(index, component);
    }

    public void ReplaceWork(System.Collections.Generic.List<int> newValue) {
        var index = GameComponentsLookup.Work;
        var component = CreateComponent<Entitas.Data.WorkComponent>(index);
        component.Value = newValue;
        ReplaceComponent(index, component);
    ...
    public void RemoveWork() {
        RemoveComponent(GameComponentsLookup.Work);
    }
}
...
public partial class GameEntity {
    ...
    public Entitas.Data.CharacterInfoPanel characterInfoPanel { get { return (Entitas.Data.CharacterInfoPanel)GetComponent(GameComponentsLookup.CharacterInfoPanel); } }
    public bool hasCharacterInfoPanel { get { return HasComponent(GameComponentsLookup.CharacterInfoPanel); } }

    public void AddCharacterInfoPanel(Entitas.Data.IScrollView newCharacterScrollView) {
        var index = GameComponentsLookup.CharacterInfoPanel;
        var component = CreateComponent<Entitas.Data.CharacterInfoPanel>(index);
        component.CharacterScrollView = newCharacterScrollView;
        AddComponent(index, component);
    }
    ...
    public void RemoveCharacterInfoPanel() {
        RemoveComponent(GameComponentsLookup.CharacterInfoPanel);
    }
}
...
public sealed partial class GameMatcher {
    ...
    static Entitas.IMatcher<GameEntity> _matcherWork;

    public static Entitas.IMatcher<GameEntity> Work {
        get {
            if (_matcherWork == null) {
                var matcher = (Entitas.Matcher<GameEntity>)Entitas.Matcher<GameEntity>.AllOf(GameComponentsLookup.Work);
                matcher.componentNames = GameComponentsLookup.componentNames;
                _matcherWork = matcher;
            }
...
public sealed partial class GameMatcher {
    ...
    static Entitas.IMatcher<GameEntity> _matcherCharacterInfoPanel;

    public static Entitas.IMatcher<GameEntity> CharacterInfoPanel {
        get {
            if (_matcherCharacterInfoPanel == null) {
                var matcher = (Entitas.Matcher<GameEntity>)Entitas.Matcher<GameEntity>.AllOf(GameComponentsLookup.CharacterInfoPanel);
                matcher.componentNames = GameComponentsLookup.componentNames;
                _matcherCharacterInfoPanel = matcher;
            }

            return _matcherCharacterInfoPanel;
        }
    }
}
